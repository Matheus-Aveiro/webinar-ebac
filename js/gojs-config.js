function start_diagram(diagram) {
	...
	myDiagram.themeManager.set("light", {
		...
		fonts: {
			name: "500 2rem InterVariable, sans-serif",
			normal: "1.6rem InterVariable, sans-serif",
			badge: "500 1.2rem InterVariable, sans-serif",
			link: "600 1.2rem InterVariable, sans-serif",
		},
	});
